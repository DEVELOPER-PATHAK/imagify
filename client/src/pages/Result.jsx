...
const Result = () => {
  ...
  return (
    ...
    <div className='flex w-full max-w-xl bg-neutral-500 text-white  text-sm p-0.5 mt-10 rounded-full'>
      ...
      <button type='submit' className='bg-zinc-900 px-10 sm:px-16 py-3 rounded-full'>Geneate</button>
...
{isImageLoaded &&
    ...
    <div className='flex gap-2 flex-wrap justify-center text-white text-sm p-0.5 mt-10 rounded-full'>
      ...
      }} className='bg-transparent border border-zinc-900 text-black px-8 py-3 rounded-full cursor-pointer'>Geneate Another</p>
